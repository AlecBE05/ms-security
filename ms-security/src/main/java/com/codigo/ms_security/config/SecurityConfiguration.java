    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests( request->
                        request.requestMatchers(Constans.ENDPOINTS_PERMIT).permitAll()
                                .requestMatchers(Constans.ENDPOINTS_USER).hasAnyAuthority(Role.USER.name())
                                .requestMatchers(Constans.ENDPOINTS_ADMIN).hasAnyAuthority(Role.ADMIN.name())
